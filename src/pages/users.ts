...
import type { UISpec, RequestContext, ButtonSpec, ColumnDef } from '@hit/feature-pack-types';

interface AuthAdminOptions {
  show_2fa_column?: boolean;
  show_oauth_status?: boolean;
...
export async function users(ctx: RequestContext): Promise<UISpec> {
  ...
  columns.push(
    ...
    { key: 'last_login', label: 'Last Login', type: 'datetime', sortable: true }
  );
