...
import { ArrowLeft, Shield, Key, Lock, Unlock, Trash2, Monitor, Globe, Mail, } from 'lucide-react';
...
export function UserDetail({ email, onNavigate }) {
    ...
    const { deleteUser, resetPassword, resendVerification, updateRoles, lockUser, unlockUser, loading: mutating, } = useUserMutations();
